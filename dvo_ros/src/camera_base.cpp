...
CameraBase::CameraBase(ros::NodeHandle& nh, ros::NodeHandle& nh_private) :
  ...
  rgb_image_subscriber_(nh,   "/kinect_camera/kinect_rgb/kinect_image_raw", 1),
  depth_image_subscriber_(nh, "/kinect_camera/kinect_depth/kinect_image_raw", 1),
  
  rgb_camera_info_subscriber_(nh, "/kinect_camera/kinect_rgb/kinect_camera_info", 1),
  depth_camera_info_subscriber_(nh, "/kinect_camera/kinect_depth/kinect_camera_info", 1),
